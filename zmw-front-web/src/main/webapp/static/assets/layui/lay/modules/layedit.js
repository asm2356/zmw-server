...
layui.define(['layer', 'form', 'code'], function (exports) {
    ...
    var setIframe = function (editor, textArea, set) {
                ...
                , image_alt: function (range) {
                    ...
                    layer.open({
                        ...
                        , content: ['<ul class="layui-form layui-form-pane" style="margin: 20px 20px 0 20px">'
                            ...
                            , '</li>'
                            , '<li class="layui-form-item" style="position: relative;display: none;">'
        ...
        , tools = {
            ...
            ,
            removeformat: '<i class="layui-icon layui-icon-form" title="清除文字样式" layedit-event="removeformat" style="font-size:18px"></i>'
            ,
